...
export class LoginComponent implements OnInit {
  ...
  getUserInfo(data: any) {
    ...
    this.loginService.getuserInfo(this.encryptUserData).subscribe(
      (data1: any) => {
        ...
        if (this.extractedrolenames === 'Admin' && this.extracteduserstatus === 'Active') {
          sessionStorage.setItem(AppModuleConstants.USER, this.extractedfirstname);
          sessionStorage.setItem(AppModuleConstants.LASTNAME, this.extractedlastname);
          sessionStorage.setItem(AppModuleConstants.ROLE, '1');
          sessionStorage.setItem(AppModuleConstants.EMAIL, this.extractedemail);
          sessionStorage.setItem(AppModuleConstants.USERNAME, this.extractedemail);
    ...
    return this.http
      ...
      .subscribe((userInfo) => {
        ...
        this.onClickLogin(checkUserInfo, idToken, accessToken);
      });
  }
  ...
  onClickLogin(userInfo: any, idToken: any, accessToken: any) {
    // console.log(
    //   'userInfo:' + userInfo,
  ...
  onLogin() {
    ...
    // console.log('data received after login', this.data);
    ...
    //   }
    // );
    // if(this.data.username==="admin@gmail.com" && this.data.password==="Admin@123")
    // {
    //   sessionStorage.setItem(AppModuleConstants.USER,this.data.username);
    //   sessionStorage.setItem(AppModuleConstants.ROLE,'1');
    //   this.router.navigate(['/Admin'])
    // }
    // else if(this.data.username==="businessuser@gmail.com" && this.data.password==="business@123")
    // {
    //   sessionStorage.setItem(AppModuleConstants.USER,this.data.username);
    //   sessionStorage.setItem(AppModuleConstants.ROLE,'2');
    //   this.router.navigate(['/BusinessUser'])
    // }
    // else if(this.data.username==="clientuser@gmail.com" && this.data.password==="clientuser@123")
    // {
    //   sessionStorage.setItem(AppModuleConstants.USER,this.data.username);
    //   sessionStorage.setItem(AppModuleConstants.ROLE,'3');
    //   this.router.navigate(['/ClientUser'])
